CLASS zcl_upload_data_script_5277 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ type table of ztacc_categ_5277,
       lt_catego    type table of ztcatego_5277,
       lt_clientes  type table of ztclientes_5277,
       lt_clnts_lib type table of ztclnts_lib_5277,
       lt_libros    type table of ztlibros_5277.
...
******** TABLA1 ********
    ...
    insert ztacc_categ_5277 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    insert ztcatego_5277 from table @lt_catego.
...
******** TABLA3 ********
    ...
    insert ztclientes_5277 from table @lt_clientes.
...
******** TABLA4
    ...
    insert ztclnts_lib_5277 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    insert ztlibros_5277 from table @lt_libros.
